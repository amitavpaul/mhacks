...
try {
	if(array_key_exists('mmy', $_GET)){		
		...
		$newURL = "http://nafsadh.com/carticle/view/$mmyParts[0]/$mmyParts[1]/$mmyParts[2]/";			
...
switch($page){
	...
	htmlHd();
		...
		Search (Make Model Year): <input type="text" name="mmy">  
		<input type="submit" value="Submit">
		</form>
		<br/><p style="color:#0077CC">enter the Manufacturer name, Model name and year seperated by space; if your name has spaces use underscore(_)</br>e.g. Honda Civic 2013</p>
		<?php
	htmlTl();
	}	break;
...
function htmlTl(){
			?>
			<br/><br/>
			Made at <a href="http://mhacks.org/">MHacks 2013</a> | 
			Automotive Data from <a href="http://automotive.hearst.com">Hearst Automotive</a> | 
			Text Analysis by <a href="http://www.alchemyapi.com/">AlchemyAPI</a><br/>
			<br/>
			brought to you by <a href="http://twitter.com/Ahsan1808">@Ahsan1808</a>, <a href="http://twitter.com/paulamitav">@paulamitav</a> & <a href="http://nafsadh.com/Khan">nafSadh</a>
			</div></body></html><?php
			}
...
if($score>$zero)$sent = "+ve"; else $sent = "-ve";
	...
	case "xml":{
		...
		case "view":{
			htmlHd();
			echo "<h2><a href='http://nafSadh.com/carticle/'>Carticle//</a></h2>";
